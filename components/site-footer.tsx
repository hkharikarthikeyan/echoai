        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/ewaste" className="text-muted-foreground hover:text-foreground">
                  E-Waste Information
                </Link>
              </li>
              <li>
                <Link href="/collection-centers" className="text-muted-foreground hover:text-foreground">
                  Collection Centers
                </Link>
              </li>
              <li>
